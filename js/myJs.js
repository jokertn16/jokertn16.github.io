const textConfig = {
    ...
    text3: "Em muốn anh là gì của em nè ^^ ",
    text4: "Nếu e ko trả lời mà thoát ra tức là muốn làm người iu a lắm rùi đó nha :v",
    text5: "Anh trai ^^",
    text6: "Người iu lun <3",
    text7: "Sao e lại chọn làm người iu vậy :vvvv",
    text8: "Gửi cho a <3",
  ...
  $(document).ready(function () {
    ...
    $("#yes").click(function () {
      ...
      Swal.fire({
        ...
        width: 900,
        padding: "3em",
        html: "<input type='text' class='form-control' id='txtReason' placeholder='Vì anh vui tánh vlll' >",
        background: '#fff url("img/iput-bg.jpg")',
        backdrop: `
                      rgba(0,0,123,0.4)
                      url("img/giphy3.gif")
